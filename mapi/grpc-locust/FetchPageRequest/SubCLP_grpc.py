...
class PerfTaskSet(TaskSet):
    ...
    def get_fetch_client(self):
        req_data = FetchPageRequest(path="/sub-category-landing-page", appInfo=self.get_app_info(),
    ...
    def get_request(self):
        return {
            "userId": "5087245",
            "appVersion": "",
            "deviceId": "ecd5e39847f6d439cf356df9cebd31c1",
            "csrf": "828d84c35e0103bb57d169b9011052d0",
            "categoryId": "1364",
            "searchBarText": "Face Mask, Sanitizers & Essentials"
        }
...
class SubCategoryLandingPage(User):
    tasks = [PerfTaskSet]
